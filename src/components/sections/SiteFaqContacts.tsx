...
const FAQ = [
  ...
  },
  {
    ...
    a: "Стоимость складывается из работы мастера и стоимости запчастей (если они требуются). Диагностика бесплатна."
  },
  {
    q: "На что распространяется гарантия?",
    a: "Гарантия 24 месяца распространяется на выполненные работы и установленные запчасти. Если проблема повторится — мастер приедет бесплатно."
  },
  {
