...
const PRICES = [
  ...
  { service: "Стиральная машина", price: "от 1 050 ₽", note: "зависит от поломки" },
  { service: "Холодильник", price: "от 1 400 ₽", note: "зависит от поломки" },
  { service: "Посудомоечная машина", price: "от 1 260 ₽", note: "зависит от поломки" },
  { service: "Духовой шкаф", price: "от 840 ₽", note: "зависит от поломки" },
  { service: "Варочная панель", price: "от 980 ₽", note: "зависит от поломки" },
  { service: "Вытяжка", price: "от 560 ₽", note: "зависит от поломки" },
  { service: "Винный шкаф", price: "от 1 400 ₽", note: "зависит от поломки" },
];
