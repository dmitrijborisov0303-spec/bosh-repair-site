        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-white/50 -mt-0.5">Авторизованный сервисный центр</div>
            </div>
          </div>
      ...
      <footer style={{ backgroundColor: "#060e1a", borderTop: "1px solid rgba(255,255,255,0.07)" }} className="py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-heading font-bold text-white tracking-wider">БОШСЕРВИС</span>
          </div>
          <p className="text-white/30 text-sm">© 2024 БошСервис. Все права защищены.</p>
