        ...
        <div className="prose prose-invert max-w-none">
          ...
          <Section title="5. Передача данных третьим лицам">
            ...
            <ul>
              ...
              <li><strong className="text-white">Botfaqtor</strong> — сервис защиты от ботов и скликивания рекламы. Получает технические данные посетителей (IP-адрес, тип браузера, поведенческие характеристики) в целях выявления и блокировки недобросовестного трафика.</li>
              <li><strong className="text-white">МангоОфис</strong> — сервис коллтрекинга и телефонии. Обрабатывает номер телефона и данные о звонках в целях учёта обращений и оценки эффективности рекламных источников.</li>
